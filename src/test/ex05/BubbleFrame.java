            ...
            addKeyListener(new KeyAdapter() {
                ...
                public void keyPressed(KeyEvent e) {
                    ...
                    // 방향키 위쪽 눌렀을때
                        ...
                        if(!player.isUp() && !player.isDown()) { // up&down 상태가 true가 아닐때 실행 초기값이 false -> !이 붙어서 true가 되면서    
                            player.up(); 
                        }
                    }
                    ...
                    /* // 방향키 아래쪽 눌렀을때
                        ...
                        if(!player.isDown() && !player.isDown()) { // 초기값이 false -> !이 붙어서
                ...
                public void keyReleased(KeyEvent e) {
                    ...
                    /* 필요없는 부분, 버그를 발생시킨다 -> n단 점프 발생 및 y좌표가 틀어짐*/
                    // // 방향키 위쪽을 뗐을때
